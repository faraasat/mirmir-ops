      ...
      {statsError && (
        <div className="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
          ...
          <p className="mt-1 text-sm text-yellow-600 dark:text-yellow-500">
            Start the API server to see real data. Run: <code className="bg-yellow-100 dark:bg-yellow-900/50 px-1 rounded">yarn workspace @mirmir/api dev</code>
          </p>
        </div>
      )}
  ...
  return (
    <div className="flex items-center gap-4 py-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">{activity.userEmail}</p>
      </div>
